...
-- -----------------------------------------------------
-- Table `type_of_computer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`type_of_computer` (
...
-- Table `accesories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`accesories` (
  ...
  CONSTRAINT `fk_id_accesories`
    ...
    REFERENCES `MySQL`.`type_of_computer` (`id_type_of_computer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- Table `person`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`person` (
...
-- Table `payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`payment` (
  ...
  CONSTRAINT `fk_id_payment_person`
    ...
    REFERENCES `MySQL`.`person` (`id_person`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- Table `shipping`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`shipping` (
  ...
  CONSTRAINT `fk_id_shipping_address`
    ...
    REFERENCES `MySQL`.`address` (`id_address`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_id_shipping_payment`
    FOREIGN KEY (`fk_id_shipping_payment`)
    REFERENCES `MySQL`.`payment` (`id_payment`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- Table `cart_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`cart_info` (
  ...
  CONSTRAINT `fk_id_cart_info_shipping`
    ...
    REFERENCES `MySQL`.`shipping` (`id_shipping`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `feedback`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`feedback` (
...
-- Table `login`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`login` (
...
-- Table `notebook_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQ`.`notebook_type` (
...
-- Table `pc_config`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`pc_config` (
...
-- Table `pc_parts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`pc_parts` (
  ...
  CONSTRAINT `fk_id_pc_parts`
    ...
    REFERENCES `MySQL`.`pc_config` (`id_pc_config`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- Table `pc_prebuild`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`pc_prebuild` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`person_has_address` (
...
-- -----------------------------------------------------
-- Table `person_has_login`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`person_has_login` (
  `id_person` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_id_login`
    ...
    REFERENCES `MySQL`.`login` (`id_login`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`roles` (
...
-- -----------------------------------------------------
-- Table `person_has_roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`person_has_roles` (
  `id_person` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_id_roles`
    ...
    REFERENCES `MySQL`.`roles` (`id_roles`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
-- there may be issues with scheme, i manualy changes it, 'cause i dont wanna doxx myself :)


-- -----------------------------------------------------
-- Table `person_has_shipping`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`person_has_shipping` (
  `id_person` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `person_has_type_of_computer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQ`.`person_has_type_of_computer` (
  `id_person` INT(11) NOT NULL,
...
-- Table `warranty`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MySQL`.`warranty` (
